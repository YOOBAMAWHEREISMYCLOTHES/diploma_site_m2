  ...
  return (
    <div className='navbar'> 
        ...
        <ul ref={menuRef} className='nav-menu'>
            ...
            <li onClick={()=>{setMenu('mens')}}><Link style={{textDecoration: 'none'}} to='/mens'>Чоловіки</Link>{menu==='mens'?<hr/>:<></>}</li>
            <li onClick={()=>{setMenu('womens')}}><Link style={{textDecoration: 'none'}} to='/womens'>Жінки</Link>{menu==='womens'?<hr/>:<></>}</li>
